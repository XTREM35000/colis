...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Gogo Export 2.0"};
...
const _SQ4zzb = defineCachedEventHandler(async (event) => {
...
const _lazy_seGb5N = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_YbPwTH = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_zJbswf = () => Promise.resolve().then(function () { return index_post$3; });
const _lazy_kQBVed = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_Z0M4fh = () => Promise.resolve().then(function () { return index_post$1; });
...
const handlers = [
  ...
  { route: '/api/brand', handler: _lazy_YbPwTH, lazy: true, middleware: false, method: "get" },
  { route: '/api/brand', handler: _lazy_zJbswf, lazy: true, middleware: false, method: "post" },
  { route: '/api/packages', handler: _lazy_kQBVed, lazy: true, middleware: false, method: "get" },
  { route: '/api/packages', handler: _lazy_Z0M4fh, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_kdwqQN, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _SQ4zzb, lazy: false, middleware: false, method: undefined },
...
const index_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    return {
      ...
      trackingNumber: `GE-${(/* @__PURE__ */ new Date()).getFullYear()}-${Math.floor(Math.random() * 1e3)}`,
      status: "pending",
      ...validatedData,
